...
@section('title', 'My Published Concerts - ConcertHub')
...
<div class="page-container container">
    ...
    <div class="page-header">
        <h1><i class="fas fa-music" style="color:#5BA3C0;"></i> My Published Concerts</h1>
    ...
    <div class="table-card">
        ...
        @else
            <div class="empty-state">
                ...
                <p>You haven't published any concerts yet.</p>
