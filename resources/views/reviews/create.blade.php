...
@section('title', 'Write a Review - ConcertHub')
...
<div class="review-form-container container">
    ...
    <div class="review-header">
        <h1><i class="fas fa-star" style="color: #7c3aed;"></i> Write Your Review</h1>
    </div>
    ...
    <div class="review-form-card">
        <form action="{{ route('reviews.store', $concert) }}" method="POST" id="reviewForm">
            @csrf
            ...
            <div class="form-section">
                ...
                <div class="char-count" id="charCount">
                    <span id="charLength">0</span> / 1000 characters
                </div>
                @error('comment')
                    <div style="color: #dc3545; font-size: 0.85rem; margin-top: 0.5rem;">
                        <i class="fas fa-times-circle"></i> {{ $message }}
