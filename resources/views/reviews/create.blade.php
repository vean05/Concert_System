...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <h1 class="mb-4">Write a Review for {{ $concert->title }}</h1>
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('reviews.store', $concert) }}" method="POST">
                        @csrf
                                ...
                                @for($i = 1; $i <= 5; $i++)
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="rating" id="rating{{ $i }}" 
                                               value="{{ $i }}" @if(old('rating') == $i) checked @endif required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('comment') is-invalid @enderror" 
                                      ...
                                      placeholder="Share your thoughts about this concert...">{{ old('comment') }}</textarea>
                            @error('comment')
