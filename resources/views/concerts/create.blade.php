...
@section('title', 'Create Concert - ConcertHub')
...
<div class="form-container container">
    ...
    <div class="form-header">
        <h1><i class="fas fa-plus-circle" style="color: #7c3aed;"></i> Create New Concert</h1>
    </div>
    ...
    <!-- Form Card -->
    <div class="form-card">
        <form action="{{ (auth()->check() && auth()->user()->is_admin) ? route('admin.concerts.store') : route('concerts.store') }}" method="POST" novalidate enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-row full">
                <div class="form-group">
                    ...
                    <input 
                        ...
                        accept="image/*"
                    >
                    <div class="help-text">Upload a concert poster or promotional image (JPEG, PNG, GIF - max 2MB)</div>
                    @error('image')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-row full">
                <div class="form-group">
                    ...
                    <textarea 
                        ...
                        name="seating_areas" 
                        rows="3" 
                        placeholder="Enter seating categories separated by commas. e.g., VIP Front, Regular, Balcony"
                    >{{ old('seating_areas') }}</textarea>
            ...
            <div class="form-actions">
                <button type="submit" class="btn-submit">
                    <i class="fas fa-save"></i> Create Concert
                </button>
                <a href="{{ route('concerts.index') }}" class="btn-cancel">
